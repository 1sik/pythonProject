...
FileName = "C:/Users/USER/PycharmProjects/pythonProject/data/midkid.csv"
...
print(data)
data.to_csv("C:/Users/USER/PycharmProjects/pythonProject/data/midkid.csv", encoding="euc-kr")
